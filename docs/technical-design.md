...
[1]: https://developer.mozilla.org/en-US/docs/Web/API/WorkerNavigator/gpu "WorkerNavigator: gpu property - Web APIs | MDN"
[2]: https://developer.mozilla.org/en-US/docs/Web/API/OffscreenCanvas "OffscreenCanvas - Web APIs | MDN"
[3]: https://web.dev/articles/cross-origin-isolation-guide "A guide to enable cross-origin isolation | Articles"
[4]: https://docs.rs/wasm-bindgen-rayon "wasm_bindgen_rayon - Rust"
[5]: https://developer.mozilla.org/en-US/docs/Web/API/DedicatedWorkerGlobalScope/requestAnimationFrame "requestAnimationFrame() method - Web APIs - MDN Web Docs"
[6]: https://arxiv.org/abs/1707.06347 "Proximal Policy Optimization Algorithms"
[7]: https://www.w3.org/TR/webgpu/ "WebGPU"
...
[9]: https://developer.mozilla.org/en-US/docs/Web/API/HTMLCanvasElement/transferControlToOffscreen "HTMLCanvasElement: transferControlToOffscreen() method"
[10]: https://github.com/tensorflow/tfjs-examples/blob/master/cart-pole/README.md "tfjs-examples/cart-pole/README.md at master · tensorflow ..."
[11]: https://storage.googleapis.com/tfjs-examples/cart-pole/dist/index.html "TensorFlow.js: Reinforcement Learning - Googleapis.com"
[12]: https://www.tensorflow.org/js/demos "TensorFlow.js demos"
[13]: https://github.com/wangjia184/rl "wangjia184/rl: Train an AI agent to play FlappyBird"
[14]: https://medium.com/%40ks2496/teaching-a-bird-to-fly-training-flappy-bird-ai-in-the-browser-with-tensorflow-d8aa90543e2c "Training Flappy Bird AI in the Browser with TensorFlow"
[15]: https://playground.tensorflow.org/ "A Neural Network Playground - TensorFlow"
[16]: https://poloclub.github.io/ganlab/ "GAN Lab: Play with Generative Adversarial Networks in ..."
[17]: https://arxiv.org/abs/1809.01587 "GAN Lab: Understanding Complex Deep Generative Models using Interactive Visual Experimentation"
[18]: https://sequence.toys/ "sequence toy"
[19]: https://vin.how/blog/train-a-language-model-in-your-browser "You probably shouldn't train a language model in ... - Vin Howe"
[20]: https://news.ycombinator.com/item?id=46004356 "Train a language model in the browser with WebGPU"
